"""This module contains the viewer used by the genetic_algorithm module to plot results."""
...
class GeneticAlgorithmViewer:
    ...
    def original_simulation(self: GeneticAlgorithmViewer) -> xr.Dataset:
        ...
        original_model.run()
        return original_model.model.state["biomass"]
    ...
    def original_simulation_acidity(self: GeneticAlgorithmViewer) -> xr.Dataset:
        ...
        original_model.run()
        # return original_model.model.state["biomass"]
        return original_model.state["biomass"]
    ...
    def best_individuals_simulations(
        ...
        #     )
        #     model.run()
        #     return model.state["biomass"].expand_dims({"individual": [individual[0]]})
